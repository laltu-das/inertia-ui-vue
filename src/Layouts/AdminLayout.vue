...
import SidebarItem from "@/components/Core/Sidebar/SidebarItem.vue";
import SidebarDropdownItem from "@/components/Core/Sidebar/SidebarDropdownItem.vue";
...
<template>
    <Modal v-if="isShowModal" persistent>
        <template #header>
